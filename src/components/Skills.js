        ...
        <div class="container px-5 py-24 mx-auto md:pl-10">
          ...
          <div class="mb-4 border-b border-gray-700 md:flex md:justify-center  flex justify-center">
            <ul
              ...
              role="tablist"
            >
              <li class="me-2 hover:text-red-500" role="presentation">
                <button
                  class={`inline-block p-4 border-b-2 rounded-t-lg  hover:text-blue-300 hover:border-blue-300 dark:hover:text-blue-300 ${
                    activeTab === 0
                      ? "border-blue-300 text-blue-300 transition duration-150 ease-in-out delay-200}"
              ...
              <li class="me-2 hover:text-red-500" role="presentation">
                ...
                >
                  <strong className="">Backend</strong>
                </button>
              </li>
              <li class="me-2  hover:text-red-500" role="presentation">
                <button
                ...
                >
                  <strong className="text-nowrap">Programming Languages</strong>
                </button>
              </li>
              {/* <li className=" hover:text-red-500" role="presentation">
                <button
                  class={`inline-block p-4 border-b-2 rounded-t-lg  hover:text-red-300 hover:border-red-600 dark:hover:text-red-500 ${
                    activeTab === 3
                      ? "border-red-600 text-red-600 transition duration-150 ease-in-out delay-200}"
          ...
          <div id="default-tab-content">
            ...
            <div
              class={`  p-4 rounded-lg bg-gray-700 dark:bg-gray-800 ${
            ...
            >
              <section class="text-gray-400 bg-gray-900 body-font">
                ...
                <div className="icon-up hover:cursor-pointer  border-red-300 bg-grey-500 rounded-full flex justify-center pb-3">
            ...
            >
              <section class="text-gray-400 bg-gray-900 body-font">
                <div class="container px-5 py-24 mx-auto">
                  <div class="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-800 sm:flex-row flex-col">
                    <div class="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full text-indigo-400 bg-gray-800 flex-shrink-0"></div>
                    <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                      <h2 class="text-white text-lg title-font font-medium mb-2">
