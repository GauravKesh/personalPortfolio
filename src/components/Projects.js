            ...
            <div class="flex flex-wrap -m-4">
              ...
              <div class="p-4 md:w-1/3 animate-dzoom ">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  <img
                    class="lg:h-48 md:h-36 w-full scale-100 object-cover object-center my-2 mx-2"
                    src={project1}
                    alt="blog"
                  />
                  <div class="p-6 ">
              ...
              <div class="p-4 md:w-1/3 animate-dzoom   ">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3">
                     This is a ui/ux design .This design was first did in figma then I developed this using HTML/CSS
                    </p>
                    <h1 class="title-font text-sm font-medium text-gray-400 pb-3 py-3">
                      <strong className="pr-2">Technology Used:-</strong>React
                      Js, HTML, CSS ,Figma
                    ...
                    <div class="flex items-center flex-wrap space-x-2 py-5">
                      {/* github link */}
                      <a class="flex gap-3 cursor-pointer text-white font-semibold bg-gradient-to-r from-gray-800 to-black px-7 py-3 rounded-full border border-gray-600 hover:scale-105 duration-200 hover:text-gray-500 hover:border-gray-800 hover:from-black hover:to-gray-900">
                        <svg
                          viewBox="0 0 24 24"
                          height="24"
                          width="24"
              ...
              <div class="p-4 md:w-1/3 animate-dzoom  ">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3">
                    I create this portfolio first time when i learnt web development .
                    </p>
                    <h1 class="title-font text-sm font-medium text-gray-400 pb-3 py-3">
                      <strong className="pr-2">Technology Used:- </strong>HTML, CSS, Javascript, Google Analytics
                    </h1>
