...
export default function About() {
  ...
  return (
    <>
      <section className="text-gray-400 bg-gray-900 body-font pt-10 pb-10 ">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="text-5xl text-10xl  title-font mb-2 text-indigo-400 text-pretty font-bold">
            Know more About Me
          </h1>
        </div>
        <div className="container mx-auto flex  py-20 md:flex-row flex-col items-center ">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="about mb-4 leading-relaxed mx-2 md:mx-0">
              A <strong className="text-blue-700">web developer</strong> with a
              passion for bringing digital visions to life. Originally from
              [mention your place of origin, my journey into the world of web
              ...
              <div className="mb-4 border-b border-gray-200 dark:border-gray-700">
                <div className="education-details">
                  ...
                  <div className="education-details-brief">
                    <h2 className="mb-3 text-1xl leading-relaxed text-yellow-700 md:mx-0">
